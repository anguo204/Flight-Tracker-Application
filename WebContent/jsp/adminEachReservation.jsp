...
<div class="list-group" style="width: 75%;">
	...
	<div class="list-group" style="width: 75%;">
		...
		<a href="${pageContext.servletContext.contextPath}/adminEachReservationDetails?ticket_number=<%= t.getNumber() %>" class="list-group-item list-group-item-action">
			<div>
				<h5>Airline: <%= t.getAirline_id() %></h5>
				<h5>Flight Number: <%= t.getFlight_number() %></h5>
				<h5>Ticket Number: <%= t.getNumber() %> </h5>
			</div>
		</a> 
		<% } %>
